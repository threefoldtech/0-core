...
func scriptsStatLua() (*asset, error) {
	...
	info := bindataFileInfo{name: "scripts/stat.lua", size: 3410, mode: os.FileMode(493), modTime: time.Unix(1487751336, 0)}
