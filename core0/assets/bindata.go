...
func scriptsStatLua() (*asset, error) {
	...
	info := bindataFileInfo{name: "scripts/stat.lua", size: 3514, mode: os.FileMode(493), modTime: time.Unix(1494842548, 0)}
...
func textLogoTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "text/logo.txt", size: 94, mode: os.FileMode(420), modTime: time.Unix(1494941234, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
