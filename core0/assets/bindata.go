...
func scriptsStatLua() (*asset, error) {
	...
	info := bindataFileInfo{name: "scripts/stat.lua", size: 3514, mode: os.FileMode(493), modTime: time.Unix(1496749602, 0)}
...
func textItsyouonlinePub() (*asset, error) {
	...
	info := bindataFileInfo{name: "text/itsyouonline.pub", size: 214, mode: os.FileMode(420), modTime: time.Unix(1496911146, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
