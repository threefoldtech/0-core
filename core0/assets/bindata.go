...
func scriptsStatLua() (*asset, error) {
	...
	info := bindataFileInfo{name: "scripts/stat.lua", size: 3514, mode: os.FileMode(493), modTime: time.Unix(1495967381, 0)}
...
func textLogoTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "text/logo.txt", size: 130, mode: os.FileMode(420), modTime: time.Unix(1496055206, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
